...
class UsuariosVO{
    ...
    private $codigoNivelUsuario , $codigoPermissaoUsuario, $sobrenomeUsuario, $codigoPacoteUsuario;
    ...
    public function getCodigoNivelUsuario() {
        return $this->codigoNivelUsuario;
    }

    public function setCodigoNivelUsuario($tmpCodigoNivelUsuario) {
        $this->codigoNivelUsuario = $tmpCodigoNivelUsuario;
